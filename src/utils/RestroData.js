export const data = [
    ...
    },
    {
      ...
      RestaurantRating: 4.2,
      RestaurantCousines: "BBQ, South Indian, North Indian, Asian, Mughlai, Street Food, Bakery, Desserts",
      RestaurantPrice: "1800 for two",
    ...
    },
    {
      ...
      RestaurantCousines: "North Indian, Asian, Italian, American, Mughlai, Bar Food, Desserts, Beverages",
      RestaurantPrice: "1700 for two",
    ...
    },
    {
      ...
      RestaurantCousines: "Bar Food, North Indian, Burger, Biryani, Fast Food, Desserts, Beverages, Kebab",
      RestaurantPrice: "2600 for two",
      RestaurantPlace: "Connaught Place, New Delhi"
    },
    {
      id: 6,
      ...
      RestaurantCousines: "North Indian, Mughlai, Chinese, Italian, Momos, Biryani, Desserts, Beverages",
      RestaurantPrice: "2400 for two",
    ...
    },
    {
      ...
      RestaurantRating: 4.5,
      RestaurantCousines: "Chinese, Asian, Pizza, Sushi, Japanese, Seafood, Pasta, Desserts",
      RestaurantPrice: "2400 for two",
    ...
    },
    {
      ...
      RestaurantImg: "https://b.zmtcdn.com/data/pictures/5/20504225/f9402eccf6ef308f4b5169c155e58a7d.jpg?fit=around|771.75:416.25&crop=771.75:416.25;*,*",
      RestaurantRating: 4.2,
      RestaurantCousines: "European, Mediterranean, Asian, Continental, Beverages, Desserts, Kebab",
      RestaurantPrice: "3500 for two",
    ...
    },
    {
      ...
      RestaurantCousines: "Bar Food, Continental, Chinese, Salad",
      RestaurantPrice: "3700 for two",
    ...
    },
    {
      ...
      RestaurantCousines: "Cafe, Coffee, Fast Food, Salad, Pasta, Beverages, Sandwich",
      RestaurantPrice: "1200 for two",
    ...
    },
    {
      ...
      RestaurantCousines: "Finger Food, North Indian, Bar Food, Modern Indian, Desserts, BeveragesCafe, Coffee, Fast Food, Salad, Pasta, Beverages, Sandwich",
      RestaurantPrice: "3000 for two",
    ...
    },
    {
      ...
      RestaurantCousines: "Cafe, Coffee, Beverages, Healthy Food, Italian, Continental, Pancake, Desserts",
      RestaurantPrice: "1200 for two",
    ...
    },
    {
      ...
      RestaurantRating: 4.3,
      RestaurantCousines: "North Indian, Asian, Italian, Sushi, Pasta, Pizza, Chinese, Bar Food",
      RestaurantPrice: "2000 for two",
    ...
    },
    {
      ...
      RestaurantRating: 4.7,
      RestaurantCousines: "North Indian, Oriental, Italian, Desserts",
      RestaurantPrice: "3000 for two",
    ...
    },
    {
      ...
      RestaurantRating: 4.2,
      RestaurantCousines: "North Indian, Mughlai, Kebab, Biryani, Desserts, Beverages",
      RestaurantPrice: "2000 for two",
    ...
    },
    {
      ...
      RestaurantCousines: "North Indian, Mughlai, Biryani, Beverages",
      RestaurantPrice: "3000 for two",
    ...
    },
    {
      ...
      RestaurantRating: 4.6,
      RestaurantCousines: "Thai, European, North Indian, Pizza, Salad",
      RestaurantPrice: "5000 for two",
    ...
    },
    {
      ...
      RestaurantRating: 4.2,
      RestaurantCousines: "North Indian, Continental, Chinese, Kebab, Salad, Pizza, Beverages",
      RestaurantPrice: "1900 for two",
